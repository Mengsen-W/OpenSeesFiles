...
31.7 3.17 -6.34 -0.005 -0.03 0.001 0.035
# 前3个最好不动
...
# cR1 小会没有非线性段，变为全直线
# 端部拉锁
uniaxialMaterial Steel02 3 156.9375 7937500 1E-15 20 0.925 0.3
#0.73 0.75 1/100
# 端部纵筋
uniaxialMaterial Steel02 4 43.5875 21366375 0.0000032 20 0.925 0.3
# 中部纵筋和箍筋
# uniaxialMaterial Steel02 5 257.5 131.378e6 0.320
uniaxialMaterial Steel02 5 32.1875 16422250 0.00006 20 0.925 0.3
...
# define cyclic
puts "cyclic begin"
recorder Node -file out_2.txt -time -closeOnWrite -node 81 -dof 1 disp
pattern Plain 2 Linear {
  load 81 1E3 0 0 0 0 0
}
Cyclic_Function 4 80 0.5 81 1 5e-5 10000
puts "cyclic end"
