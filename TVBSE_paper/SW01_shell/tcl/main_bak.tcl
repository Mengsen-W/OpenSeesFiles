...
31.7 3.17 -6.16 -0.003 -0.006 0.001 0.04
# 前3个最好不动
# 变小会使屈服段不明显，变大会使屈服段明显
# 调整没有影响
# 增大会增大前期刚度
# 能显著增加强度
nDMaterial PlateFromPlaneStress 2 1 1.23e6
# 调整可以增加强度
...
# cR1 小会没有非线性段，变为全直线
# 端部拉锁
uniaxialMaterial Steel02 3 1255.5 63.5e6 1E-15
# 端部纵筋
# uniaxialMaterial Steel02 4 348.7 170.931e6 0.2210
uniaxialMaterial Steel02 4 348.7 120.931e6 0.002210
# 中部纵筋和箍筋
# uniaxialMaterial Steel02 5 257.5 131.378e6 0.320
uniaxialMaterial Steel02 5 257.5 100.378e6 0.00320
...
Cyclic_Function 2 80 0.1 81 1 5e-5 200000
puts "cyclic end"
