...
# cR1 小会没有非线性段，变为全直线
# 端部拉锁
uniaxialMaterial Steel02 3 125.55 63.5e5 1E-15
#0.73 0.75 1/100
# 端部纵筋
uniaxialMaterial Steel02 4 34.87 170.931e5 0.002210 19 0.01 0.5
# 中部纵筋和箍筋
# uniaxialMaterial Steel02 5 257.5 131.378e6 0.320
uniaxialMaterial Steel02 5 25.75 131.378e5 0.0032 19 0.01 0.5
...
Cyclic_Function 1 80 0.5 81 1 1e-4 1000000
puts "cyclic end"
