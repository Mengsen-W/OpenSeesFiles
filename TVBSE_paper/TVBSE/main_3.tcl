...
set factor [expr abs(10 - $index) * 0.1 * 1]
uniaxialMaterial Concrete02 6 -31.7 -0.003 -6.34 -0.005 $factor 3.17 400
...
puts "cyclic begin"
recorder Node -file output/out_3_$index.txt -time -node 2 -dof 2 disp
