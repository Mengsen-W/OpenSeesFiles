...
# 端部拉锁
set factor [expr abs(10 - $index) * 0.1 * 0.15]
uniaxialMaterial Steel02 3 1255.5 64.9e3 1e-20 15 0.925 $factor
...
uniaxialMaterial Concrete02 6 -31.7 -0.003 -6.34 -0.005 1e-16 3.17 4000
...
puts "cyclic begin"
recorder Node -file output/out_5_$index.txt -time -node 2 -dof 2 disp
...
numberer RCM
system BandGeneral
set protocol [Build_Protocol 4 20 2]
# puts "protocol = $protocol"

# node dof step
SmartAnalyzeStatic 2 2 2 $protocol
