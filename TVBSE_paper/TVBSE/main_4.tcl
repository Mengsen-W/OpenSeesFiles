...
set factor [expr abs(10 - $index) * 0.1 * 15]
uniaxialMaterial Steel02 3 1255.5 64.9e3 1e-20 $factor 0.925 0.15
# 端部纵筋
uniaxialMaterial Steel02 4 244.1 119.65e3 0.1105

# 中部纵筋和箍筋
uniaxialMaterial Steel02 5 180.25 91.97e3 0.
...
puts "cyclic begin"
recorder Node -file output/out_4_$index.txt -time -node 2 -dof 2 disp
