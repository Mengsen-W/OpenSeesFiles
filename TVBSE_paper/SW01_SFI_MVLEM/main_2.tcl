...
wipe
source lib.tcl
# ModelInfo_Proc output/model_log_2.txt
...
# 竖向荷载
# recorder Node -file output/gravity_2.txt -time -node 11 -dof 2 disp
...
puts "cyclic begin"
recorder Node -file output/out_2.txt -time -closeOnWrite -node 11 -dof 1 disp
