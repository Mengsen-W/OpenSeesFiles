...
puts "\nOutput"
recorder Node -file F-Steel-2-Disp.txt -time -node 2607 -dof 1 disp
puts "End of Output"
...
Cyclic_Function 2 50 0.5 2607 1 1E-2 1000
ModelInfo_Proc model-Steel-2.txt
puts "\nAll of End\n"
