...
class MVLEM : public Element {
 public:
  // constructors
  MVLEM(int tag, double Dens, int Nd1, int Nd2,
        UniaxialMaterial **materialsConcrete, UniaxialMaterial **materialsSteel,
        UniaxialMaterial **materialsShear, double *Rho, double *thickness,
        double *width, int mm, double cc);
 ...
 private:
  ...
  UniaxialMaterial *
      *theMaterialsConcrete;  // pointers to Concrete uniaxial material
