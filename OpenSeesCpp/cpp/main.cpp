...
int main(int argc, char **argv) {
  ...
  Node *node3 = new Node(3, 2, 168.0, 96.0);
  ...
  Truss *truss1 = new Truss(1, 2, 1, 2, *theMaterial, 10.0);
  Truss *truss2 = new Truss(2, 2, 2, 3, *theMaterial, 10.0);
  Truss *truss3 = new Truss(3, 2, 3, 4, *theMaterial, 10.0);
  Truss *truss4 = new Truss(4, 2, 4, 1, *theMaterial, 10.0);
  ...
  SP_Constraint *sp1 = new SP_Constraint(1, 0, 0);
  SP_Constraint *sp2 = new SP_Constraint(1, 1, 0);
  SP_Constraint *sp3 = new SP_Constraint(2, 0, 0);
  SP_Constraint *sp4 = new SP_Constraint(2, 1, 0);
