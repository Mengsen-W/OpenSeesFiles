'''
@Author: Mengsen.Wang
@Date: 2020-09-15 19:37:19
@Last Modified by: Mengsen.Wang
@Last Modified time: 2020-09-15 19:37:19
'''
...
# Helper function to determine if a variable is a floating point value or not
#
def isfloat(value):
    try:
        float(value)
...
def toOpenSeesPy(infile, outfile):
    outfile.write("# from TclToPy.py by mengsen_wang\n")
...
outfile = open("LibLog.py", 'w')
toOpenSeesPy("LibLog.tcl", outfile)
outfile.close()
